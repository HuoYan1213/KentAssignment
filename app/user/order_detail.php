...
<div class="order-page">
    ...
    <div class="order-summary">
        ...
        <div><span>Packaging:</span> <span>$3.00</span></div>
        <div><span>Tax (6%):</span> <span>$<?= number_format($subtotal*0.06,2) ?></span></div>
        <div class="total"><span>Total:</span> <span>$<?= number_format($subtotal + 3 + $subtotal*0.06,2) ?></span></div>
    </div>
