...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_FILES['p_photo']['name'])) {
        ...
        move_uploaded_file($_FILES['p_photo']['tmp_name'], $upload_dir . $p_photo);
    }
            ...
            <div class="form-group">
                ...
                <?php if (isset($product) && !empty($product->p_photo)): ?>
                    <div class="photo-preview">
                        <img src="../product/images_product/<?= htmlspecialchars($product->p_photo) ?>" alt="<?= htmlspecialchars($product->p_name) ?>">
