    ...
    <table class="user-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="../user/images_user/<?= htmlspecialchars($s->photo) ?>" class="user-photo" alt="<?= htmlspecialchars($s->name) ?>"></td>
                <td>
                    <a href="user_edit.php?edit_id=<?= urlencode($s->id) ?>" class="action-btn btn-edit">Edit</a>
                    <a href="?role=<?= htmlspecialchars($role) ?>&delete_id=<?= urlencode($s->id) ?>" class="action-btn btn-delete" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                </td>
            </tr>
            <?php endforeach ?>
        </tbody>
